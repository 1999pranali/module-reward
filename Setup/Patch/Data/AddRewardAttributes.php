...
namespace Coditron\Reward\Setup\Patch\Data;
    ...
    PatchVersionInterface
{
    ...
    public function apply()
    {
        ...
        <p><img src="{{view url="Coditron_Reward::images/payment.png"}}" alt="Payment Information" /></p>
        ...
        <p><img src="{{view url="Coditron_Reward::images/my_account.png"}}" alt="My Account" /></p>
