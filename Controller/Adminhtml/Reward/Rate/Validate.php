...
class Validate extends \Coditron\Reward\Controller\Adminhtml\Reward\Rate
{
    /**
     * Validate Action
     *
    ...
    public function execute()
    {
        ...
        } elseif ($post['direction'] == \Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_CURRENCY &&
            ((int)$post['value'] <= 0 ||
        ...
        } elseif ($post['direction'] == \Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_POINTS &&
            ((double)$post['value'] <= 0 ||
