...
namespace Coditron\Reward\Block\Adminhtml\Customer\Edit\Tab\Reward\Management\Balance;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * Reward collection
     *
     * @var \Coditron\Reward\Model\ResourceModel\Reward\CollectionFactory
     */
     ...
     *
     * @var \Coditron\Reward\Model\Source\WebsiteFactory
     */
     ...
     * @param \Coditron\Reward\Model\ResourceModel\Reward\CollectionFactory $rewardsFactory
     * @param \Coditron\Reward\Model\Source\WebsiteFactory $websitesFactory
    ...
    public function __construct(
        ...
        \Coditron\Reward\Model\ResourceModel\Reward\CollectionFactory $rewardsFactory,
        \Coditron\Reward\Model\Source\WebsiteFactory $websitesFactory,
    ...
    protected function _afterLoadCollection()
    {
        ...
        /* @var $item \Coditron\Reward\Model\Reward */
    ...
    protected function _afterToHtml($html)
    {
        ...
        if ($this->_customerHasOrphanPoints) {
            $confirmMessage = __('Are you sure you want to delete these points?');
            $deleteOrhanPointsButton = $this->getLayout()->createBlock(
                \Magento\Backend\Block\Widget\Button::class
            )->setData(
                [
                    'label' => __('Delete Orphan Points'),
                    'onclick' => 'deleteConfirm(\'' . $this->escapeJs($confirmMessage) . '\', \''
                        . $this->escapeUrl($this->getDeleteOrphanPointsUrl()) . '\', {data: {}})',
     ...
     * Return grid row url
     *
     * @param \Coditron\Reward\Model\Reward $row
     * @return string
