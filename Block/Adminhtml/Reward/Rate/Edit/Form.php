...
namespace Coditron\Reward\Block\Adminhtml\Reward\Rate\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    /**
     * @var \Coditron\Reward\Model\Source\Customer\GroupsFactory
     */
     ...
     * @param \Coditron\Reward\Model\Source\Customer\GroupsFactory $groupsFactory
     * @param array $data
     */
    public function __construct(
        ...
        \Coditron\Reward\Model\Source\Customer\GroupsFactory $groupsFactory,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $rateRenderer = $this->getLayout()->createBlock(
            \Coditron\Reward\Block\Adminhtml\Reward\Rate\Edit\Form\Renderer\Rate::class
        )->setRate(
            $this->getRate()
        );
        $direction = $this->getRate()->getDirection();
        if ($direction == \Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_CURRENCY) {
            $fromIndex = 'points';
