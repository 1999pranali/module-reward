 ...
 * @method \Coditron\Reward\Model\Reward\Rate setWebsiteId(int $value)
 * @method int getCustomerGroupId()
 * @method \Coditron\Reward\Model\Reward\Rate setCustomerGroupId(int $value)
 * @method int getDirection()
 * @method \Coditron\Reward\Model\Reward\Rate setDirection(int $value)
 * @method \Coditron\Reward\Model\Reward\Rate setPoints(int $value)
 * @method \Coditron\Reward\Model\Reward\Rate setCurrencyAmount(float $value)
 *
 * @api
 * @since 100.0.2
 */
class Rate extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @param \Coditron\Reward\Model\ResourceModel\Reward\Rate $resource
    ...
    public function __construct(
        ...
        \Coditron\Reward\Model\ResourceModel\Reward\Rate $resource,
    ...
    {
        $this->_init(\Coditron\Reward\Model\ResourceModel\Reward\Rate::class);
    }
