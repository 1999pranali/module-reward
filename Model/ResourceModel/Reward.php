...
namespace Coditron\Reward\Model\ResourceModel;

use Coditron\Reward\Model\Reward as ModelReward;
...
class Reward extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('coditron_reward', 'reward_id');
    }
    ...
    public function saveRewardSalesrule($ruleId, $pointsDelta)
    {
        $this->getConnection()->insertOnDuplicate(
            $this->getTable('coditron_reward_salesrule'),
