 ...
 * @method \Coditron\Reward\Model\Reward setCustomerId(int $value)
 * @method \Coditron\Reward\Model\Reward setWebsiteId(int $value)
 * @method int getPointsBalance()
 * @method \Coditron\Reward\Model\Reward setPointsBalance(int $value)
 * @method \Coditron\Reward\Model\Reward setWebsiteCurrencyCode(string $value)
 * @method \Coditron\Reward\Model\Reward setPointsDelta(int $value)
 * @method \Coditron\Reward\Model\Reward setAction(int $value)
 * @method \Coditron\Reward\Model\Reward setComment(string $value)
...
{
    const XML_PATH_BALANCE_UPDATE_TEMPLATE = 'coditron_reward/notification/balance_update_template';

    const XML_PATH_BALANCE_WARNING_TEMPLATE = 'coditron_reward/notification/expiry_warning_template';

    const XML_PATH_EMAIL_IDENTITY = 'coditron_reward/notification/email_sender';

    const XML_PATH_MIN_POINTS_BALANCE = 'coditron_reward/general/min_points_balance';
     ...
     * Reward customer
     *
     * @var \Coditron\Reward\Helper\Customer
     */
     ...
     *
     * @var \Coditron\Reward\Model\Reward\HistoryFactory
     */
     ...
     * Reward model
     *
     * @var \Coditron\Reward\Model\Reward
     */
    protected $_reward;
     ...
     * @param \Coditron\Reward\Helper\Customer $rewardCustomer
     * @param \Coditron\Reward\Helper\Data $rewardData
     * @param \Magento\Store\Model\StoreManagerInterface $storeManager
     * @param \Magento\Framework\Locale\CurrencyInterface $localeCurrency
     * @param \Coditron\Reward\Model\ActionFactory $actionFactory
     * @param \Coditron\Reward\Model\Reward\HistoryFactory $historyFactory
    ...
    public function __construct(
        ...
        \Coditron\Reward\Helper\Customer $rewardCustomer,
        \Coditron\Reward\Helper\Data $rewardData,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Magento\Framework\Locale\CurrencyInterface $localeCurrency,
        \Coditron\Reward\Model\ActionFactory $actionFactory,
        \Coditron\Reward\Model\Reward\HistoryFactory $historyFactory,
    ...
    {
        parent::_construct();
        $this->_init(\Coditron\Reward\Model\ResourceModel\Reward::class);
        self::$_actionModelClasses = self::$_actionModelClasses + [
                self::REWARD_ACTION_ADMIN => \Coditron\Reward\Model\Action\Admin::class,
                self::REWARD_ACTION_ORDER => \Coditron\Reward\Model\Action\Order::class,
                self::REWARD_ACTION_REGISTER => \Coditron\Reward\Model\Action\Register::class,
                self::REWARD_ACTION_NEWSLETTER => \Coditron\Reward\Model\Action\Newsletter::class,
                self::REWARD_ACTION_INVITATION_CUSTOMER => \Coditron\Reward\Model\Action\InvitationCustomer::class,
                self::REWARD_ACTION_INVITATION_ORDER => \Coditron\Reward\Model\Action\InvitationOrder::class,
                self::REWARD_ACTION_REVIEW => \Coditron\Reward\Model\Action\Review::class,
                self::REWARD_ACTION_ORDER_EXTRA => \Coditron\Reward\Model\Action\OrderExtra::class,
                self::REWARD_ACTION_CREDITMEMO => \Coditron\Reward\Model\Action\Creditmemo::class,
                self::REWARD_ACTION_SALESRULE => \Coditron\Reward\Model\Action\Salesrule::class,
                self::REWARD_ACTION_REVERT => \Coditron\Reward\Model\Action\OrderRevert::class,
                self::REWARD_ACTION_CREDITMEMO_VOID => \Coditron\Reward\Model\Action\Creditmemo\VoidAction::class,
            ];
    }
     ...
     * @return \Coditron\Reward\Model\Action\AbstractAction|null
     */
     ...
     * Getter
     *
     * @return \Coditron\Reward\Model\Reward\History
     */
    ...
    {
        return $this->_getRateByDirection(\Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_CURRENCY);
    }
    ...
    {
        return $this->_getRateByDirection(\Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_POINTS);
    }
    ...
    public function getRateDirectionByAction()
    {
        switch ($this->getAction()) {
            case self::REWARD_ACTION_ORDER_EXTRA:
                $direction = \Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_POINTS;
                break;
            default:
                $direction = \Coditron\Reward\Model\Reward\Rate::RATE_EXCHANGE_DIRECTION_TO_CURRENCY;
                break;
        }
        return $direction;
    }
     ...
     *
     * @param \Coditron\Reward\Model\Action\AbstractAction $action
     * @return int|null
     */
    public function estimateRewardPoints(\Coditron\Reward\Model\Action\AbstractAction $action)
    {
     ...
     * @return float|null
     */
    public function estimateRewardAmount(\Coditron\Reward\Model\Action\AbstractAction $action)
    {
     ...
     * @param int $websiteId
     * @return $this
     * @see \Coditron\Reward\Model\ResourceModel\Reward\History\Collection::loadExpiredSoonPoints()
     */
    public function sendBalanceWarningNotification($item, $websiteId)
    {
        ...
        $remainingDays = $this->_scopeConfig->getValue(
            'coditron_reward/notification/expiry_day_before',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store
        );
